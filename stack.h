...
#else
#define stack_entry(node_ptr, type, member) ((type *)((char *)(node_ptr)-offsetof(type, member)))
#endif
...
#define stack_for_each(cursor_node_ptr, stack_ptr)                                                                                         \
  for (cursor_node_ptr = (stack_ptr)->tail; cursor_node_ptr; cursor_node_ptr = cursor_node_ptr->prev)
...
#define stack_for_each_safe(cursor_node_ptr, backup_node_ptr, stack_ptr)                                                                   \
  for (cursor_node_ptr = (stack_ptr)->tail, backup_node_ptr = cursor_node_ptr ? cursor_node_ptr->prev : NULL;                              \
                                                                                                                                           \
       cursor_node_ptr;                                                                                                                    \
                                                                                                                                           \
       cursor_node_ptr = backup_node_ptr, backup_node_ptr = cursor_node_ptr ? cursor_node_ptr->prev : NULL)
